...
npcs = {
    ...
    (2, 4): {
        ...
        "description": "The Guard Captain requests your aid in defending the village from an impending attack. Accepting the quest could lead to battle and glory."
    },
    (1, 1): {
        "name": "Scholar",
...
def interact_with_npc(character, location):
    ...
    """
    npc_info: dict = npcs.get(location, {})
